...
public class AuthServiceImpl implements AuthService {
	...
	public ResponseEntity<?> login(LoginDto loginDto) {
		...
		try {
			...
			return new ResponseEntity<>(
					new CommonResponse<>(401, new UnauthorizedResponseDto("Invalid username or password!")),
	...
	public ResponseEntity<?> register(RegisterDto registerDto) {
		if (userRepository.existsByUsername(registerDto.getUsername())) {
			UserAlreadyExistResponseDto userAlreadyExistDto =
					new UserAlreadyExistResponseDto("Username already exist.");
			return new ResponseEntity<>(new CommonErrorResponse<>(409, userAlreadyExistDto), HttpStatus.CONFLICT);
		}
